...
const cells = [
  ...
  ['java', 'KmpSearch.java', javaSource, null, null, 'javac -J-Xmx128m -d output/implementation-tests implementations/java/string-search/v8-knuth-morris-pratt-d7l8/KmpSearch.java && java -Xmx64m -cp output/implementation-tests KmpSearch'],
