...
const batches = [
  {
    ...
    files: [
      ...
      ['java', 'JumpHash.java', jh_java, null, null, 'javac -J-Xmx128m -d output/implementation-tests implementations/java/hashing/jumphash/JumpHash.java && java -Xmx64m -cp output/implementation-tests JumpHash', true],
  ...
  },
  {
    ...
    files: [
      ...
      ['java', 'Reservoir.java', res_java, null, null, 'javac -J-Xmx128m -d output/implementation-tests implementations/java/sampling/reservoir/Reservoir.java && java -Xmx64m -cp output/implementation-tests Reservoir', true],
  ...
  },
  {
    ...
    files: [
      ...
      ['java', 'CycleSort.java', cs_java, null, null, 'javac -J-Xmx128m -d output/implementation-tests implementations/java/sorting/cyclesort/CycleSort.java && java -Xmx64m -cp output/implementation-tests CycleSort', true],
  ...
  },
  {
    ...
    files: [
      ...
      ['java', 'StoogeSort.java', st_java, null, null, 'javac -J-Xmx128m -d output/implementation-tests implementations/java/sorting/stoogesort/StoogeSort.java && java -Xmx64m -cp output/implementation-tests StoogeSort', true],
