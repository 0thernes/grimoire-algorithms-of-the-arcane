...
const files = [
  ...
  ['java', 'BoyerMoore.java', java, null, null, 'javac -J-Xmx128m -d output/implementation-tests implementations/java/string-search/boyermoore/BoyerMoore.java && java -Xmx64m -cp output/implementation-tests BoyerMoore', true],
