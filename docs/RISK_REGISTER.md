...
| R-011 | P1 | The repo could overclaim that 50,000 native implementations are complete. | Mitigated in 0.9.13. | `coverage-summary.json`, `catalog-adapters-summary.json`, `verified-cells.json`, and ledger-aware audits separate generated catalog adapters from native implementations and count only tested native cells as verified. |
| R-012 | P2 | Public publishing could proceed without attribution/non-commercial notices. | Mitigated in 0.9.13. | `LICENSE.md`, `NOTICE.md`, `CONTRIBUTING.md`, `SECURITY.md`, and `CITATION.cff` are copied by the Pages branch-publish workflow. |
