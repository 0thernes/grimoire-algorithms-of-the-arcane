...
| Boyer-Moore | `boyermoore` | java | string-search | `javac -J-Xmx128m -d output/implementation-tests implementations/java/string-search/boyermoore/BoyerMoore.java && java -Xmx64m -cp output/implementation-tests BoyerMoore` |
...
| Jump Consistency Hashing | `jumphash` | java | hashing | `javac -J-Xmx128m -d output/implementation-tests implementations/java/hashing/jumphash/JumpHash.java && java -Xmx64m -cp output/implementation-tests JumpHash` |
...
| Reservoir Sampling | `reservoir` | java | sampling | `javac -J-Xmx128m -d output/implementation-tests implementations/java/sampling/reservoir/Reservoir.java && java -Xmx64m -cp output/implementation-tests Reservoir` |
...
| Cycle Sort | `cyclesort` | java | sorting | `javac -J-Xmx128m -d output/implementation-tests implementations/java/sorting/cyclesort/CycleSort.java && java -Xmx64m -cp output/implementation-tests CycleSort` |
...
| Stooge Sort | `stoogesort` | java | sorting | `javac -J-Xmx128m -d output/implementation-tests implementations/java/sorting/stoogesort/StoogeSort.java && java -Xmx64m -cp output/implementation-tests StoogeSort` |
...
| Cocktail Shaker Sort | `cocktail` | java | sorting | `javac -J-Xmx128m -d output/implementation-tests implementations/java/sorting/cocktail/CocktailSort.java && java -Xmx64m -cp output/implementation-tests CocktailSort` |
...
| Knuth-Morris-Pratt | `v8-knuth-morris-pratt-d7l8` | java | string-search | `javac -J-Xmx128m -d output/implementation-tests implementations/java/string-search/v8-knuth-morris-pratt-d7l8/KmpSearch.java && java -Xmx64m -cp output/implementation-tests KmpSearch` |
