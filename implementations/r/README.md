...
Language target ID: `r`

Runtime family: statistics

Primary extension: `.R`

Expected runtime/toolchain: R
...
```text
implementations/r/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for R. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
