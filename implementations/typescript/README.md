...
```text
implementations/typescript/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for TypeScript. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
...
- Knuth-Morris-Pratt (`v8-knuth-morris-pratt-d7l8`): `deno run --quiet implementations/typescript/string-search/v8-knuth-morris-pratt-d7l8/test.ts`
