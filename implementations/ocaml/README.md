...
Language target ID: `ocaml`

Runtime family: ML functional

Primary extension: `.ml`

Expected runtime/toolchain: native / bytecode
...
```text
implementations/ocaml/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for OCaml. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
