...
Language target ID: `vba`

Runtime family: office automation

Primary extension: `.bas`

Expected runtime/toolchain: Office host
...
```text
implementations/vba/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for VBA. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
