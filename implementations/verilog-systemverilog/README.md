...
Language target ID: `verilog-systemverilog`

Runtime family: hardware description

Primary extension: `.sv`

Expected runtime/toolchain: HDL simulator / synthesis
...
```text
implementations/verilog-systemverilog/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Verilog / SystemVerilog. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
