...
Language target ID: `scala`

Runtime family: functional JVM

Primary extension: `.scala`
...
```text
implementations/scala/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Scala. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
