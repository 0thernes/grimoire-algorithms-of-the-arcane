...
Language target ID: `crystal`

Runtime family: typed Ruby-like

Primary extension: `.cr`
...
```text
implementations/crystal/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Crystal. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
