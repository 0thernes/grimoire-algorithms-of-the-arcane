...
Language target ID: `racket`

Runtime family: language lab

Primary extension: `.rkt`

Expected runtime/toolchain: Racket
...
```text
implementations/racket/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Racket. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
