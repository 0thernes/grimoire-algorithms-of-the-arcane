...
Language target ID: `kotlin`

Runtime family: modern JVM

Primary extension: `.kt`

Expected runtime/toolchain: JVM / native
...
```text
implementations/kotlin/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Kotlin. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
