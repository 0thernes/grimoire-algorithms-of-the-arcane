...
Language target ID: `sql`

Runtime family: database query

Primary extension: `.sql`

Expected runtime/toolchain: ANSI SQL
...
```text
implementations/sql/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for SQL. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
