...
Language target ID: `ada`

Runtime family: high-integrity systems

Primary extension: `.adb`
...
```text
implementations/ada/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Ada. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
