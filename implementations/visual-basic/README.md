...
```text
implementations/visual-basic/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Visual Basic .NET. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
