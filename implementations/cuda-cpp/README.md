...
Language target ID: `cuda-cpp`

Runtime family: GPU computing

Primary extension: `.cu`

Expected runtime/toolchain: CUDA
...
```text
implementations/cuda-cpp/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for CUDA C++. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
