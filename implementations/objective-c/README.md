...
Language target ID: `objective-c`

Runtime family: Apple/native

Primary extension: `.m`

Expected runtime/toolchain: native / Apple
...
```text
implementations/objective-c/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Objective-C. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
