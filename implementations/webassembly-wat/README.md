...
Language target ID: `webassembly-wat`

Runtime family: portable bytecode

Primary extension: `.wat`

Expected runtime/toolchain: WebAssembly
...
```text
implementations/webassembly-wat/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for WebAssembly Text. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
