...
Language target ID: `php`

Runtime family: web scripting

Primary extension: `.php`

Expected runtime/toolchain: PHP runtime
...
```text
implementations/php/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for PHP. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
