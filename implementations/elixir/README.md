...
Language target ID: `elixir`

Runtime family: actor/concurrent

Primary extension: `.ex`
...
```text
implementations/elixir/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Elixir. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
