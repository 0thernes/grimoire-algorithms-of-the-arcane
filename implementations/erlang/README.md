...
Language target ID: `erlang`

Runtime family: actor/concurrent

Primary extension: `.erl`

Expected runtime/toolchain: BEAM
...
```text
implementations/erlang/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Erlang. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
