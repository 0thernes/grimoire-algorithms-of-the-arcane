...
Language target ID: `swift`

Runtime family: Apple/native

Primary extension: `.swift`
...
```text
implementations/swift/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Swift. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
