...
Language target ID: `scheme`

Runtime family: Lisp

Primary extension: `.scm`

Expected runtime/toolchain: Scheme
...
```text
implementations/scheme/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Scheme. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
