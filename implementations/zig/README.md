...
Language target ID: `zig`

Runtime family: systems

Primary extension: `.zig`
...
```text
implementations/zig/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Zig. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
