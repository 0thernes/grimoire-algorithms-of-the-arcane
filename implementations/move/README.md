...
Language target ID: `move`

Runtime family: smart contracts

Primary extension: `.move`

Expected runtime/toolchain: Move VM
...
```text
implementations/move/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Move. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
