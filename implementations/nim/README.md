...
Language target ID: `nim`

Runtime family: systems scripting

Primary extension: `.nim`

Expected runtime/toolchain: native / transpiled C
...
```text
implementations/nim/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Nim. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
