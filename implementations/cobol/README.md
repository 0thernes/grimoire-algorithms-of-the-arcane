...
Language target ID: `cobol`

Runtime family: business systems

Primary extension: `.cob`

Expected runtime/toolchain: native / mainframe
...
```text
implementations/cobol/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for COBOL. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
