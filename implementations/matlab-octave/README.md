...
Language target ID: `matlab-octave`

Runtime family: numerical computing

Primary extension: `.m`

Expected runtime/toolchain: MATLAB / GNU Octave
...
```text
implementations/matlab-octave/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for MATLAB / Octave. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
