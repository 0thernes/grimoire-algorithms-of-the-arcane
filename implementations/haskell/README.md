...
Language target ID: `haskell`

Runtime family: pure functional

Primary extension: `.hs`

Expected runtime/toolchain: GHC
...
```text
implementations/haskell/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Haskell. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
