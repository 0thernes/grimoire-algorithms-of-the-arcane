...
Language target ID: `prolog`

Runtime family: logic programming

Primary extension: `.pl`

Expected runtime/toolchain: SWI-Prolog
...
```text
implementations/prolog/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Prolog. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
