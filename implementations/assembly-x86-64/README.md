...
Language target ID: `assembly-x86-64`

Runtime family: assembly
...
```text
implementations/assembly-x86-64/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for x86-64 Assembly. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
