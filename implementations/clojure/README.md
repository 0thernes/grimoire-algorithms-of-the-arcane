...
Language target ID: `clojure`

Runtime family: Lisp/JVM

Primary extension: `.clj`

Expected runtime/toolchain: JVM / JS
...
```text
implementations/clojure/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Clojure. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
