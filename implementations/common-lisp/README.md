...
Language target ID: `common-lisp`

Runtime family: Lisp

Primary extension: `.lisp`

Expected runtime/toolchain: Common Lisp
...
```text
implementations/common-lisp/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Common Lisp. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
