...
Language target ID: `rust`

Runtime family: safe systems

Primary extension: `.rs`
...
```text
implementations/rust/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Rust. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
