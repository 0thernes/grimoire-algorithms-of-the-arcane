...
Language target ID: `solidity`

Runtime family: smart contracts

Primary extension: `.sol`

Expected runtime/toolchain: EVM
...
```text
implementations/solidity/catalog/algorithms.json
```

That adapter contains all 1000 GRIMOIRE records for Solidity. It is meant for discovery, code generation, docs, and audit tooling. It is not counted as a native algorithm implementation.
